...
import com.hzf.core.base.BaseModelTree;
import com.hzf.core.base.BaseQuery;
...
// 该类用于返回一个表格Json
public class DataTable extends AjaxResult {
...
//                Object v = var1.getRightExpression().getASTNode().jjtGetValue();
    ...
    public String ToPageJson(BaseQuery pagination) {
        Map<String, Object> m = GetMapValue();
        ...
        this.setValue(m);
        AjaxResult ar = new AjaxResult(this);
